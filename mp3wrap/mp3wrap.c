...
#pragma warning (disable : 4057 4255 4242 4244 4706 4668)
...
unsigned char id3[ID3LEN] = 
{
    ...
    #else
         'I',  'D',  '3', 0x03, '\0', '\0', '\0', '\0', 0x03,  'B',  'T',  'R',  'C',  'K', '\0', '\0',
        '\0', 0x03, '\0', '\0', '\0',  '0',  '0',  'T',  'E',  'N',  'C', '\0', '\0', '\0', 0x11,  '@',
        '\0', '\0',  'M',  'p',  '3',  'W',  'r',  'a',  'p',  ' ',  ' ',  'v',  '.',  ' ',  ' ',  '0',
         '.',  '0',  'W',  'X',  'X',  'X', '\0', '\0', '\0',  ' ', '\0', '\0', '\0', '\0',  'h',  't',
         't',  'p',  ':',  '/',  '/',  'm',  'p',  '3',  'w',  'r',  'a',  'p',  '.',  's',  'o',  'u',
         'r',  'c',  'e',  'f',  'o',  'r',  'g',  'e',  '.',  'n',  'e',  't',  'T',  'C',  'O',  'P',
        '\0', '\0', '\0', 0x01, '\0', '\0', '\0',  'T',  'O',  'P',  'E', '\0', '\0', '\0', 0x01, '\0',
        '\0', '\0',  'T',  'C',  'O',  'M', '\0', '\0', '\0', 0x01, '\0', '\0', '\0',  'C',  'O',  'M',
         'M', '\0',  '\0', '\0', 0xa0, '\0', '\0', '\0', '\0', 'e',  ' ', '\0',  'T',  'h',  'i',  's',
         ' ',  'f',  'i',  'l',  'e',  ' ',  'i',  's',  ' ',  'w',  'r',  'a',  'p',  'p',  'e',  'd',
         ' ',  'w',  'i',  't',  'h',  ' ',  'M',  'p',  '3',  'W',  'r',  'a',  'p',  '.',  '  ', 'G',
         'e',  't',  ' ',  'm',  'p',  '3',  's',  'p',  'l',  't',  ',',  ' ',  't',  'h',  'e',  ' ',
         'f',  'r',  'e',  'e',  ' ',  't',  'o',  'o',  'l',  ' ',  't',  'o',  ' ',  's',  'p',  'l',
         'i',  't',  ' ',  'o',  'r',  'i',  'g',  'i',  'n',  'a',  'l',  ' ',  'f',  'i',  'l',  'e',
         's',  ' ',  'a',  't',  ' ',  'h',  't',  't',  'p',  ':',  '/',  '/',  'm',  'p',  '3',  's',
         'p',  'l',  't',  '.',  's',  'o',  'u',  'r',  'c',  'e',  'f',  'o',  'r',  'g',  'e',  '.',
         'n',  'e',  't',  '.',  ' ',  'P',  'l',  'e',  'a',  's',  'e',  ' ',  'd',  'o',  ' ',  'n',
         'o',  't',  ' ',  'r',  'e',  'm',  'o',  'v',  'e',  ' ',  't',  'h',  'i',  's',  ' ',  'c',
         'o',  'm',  'm',  'e',  'n',  't',  '.',  'T',  'C',  'O',  'N', '\0', '\0', '\0', 0x01, '\0',
        '\0', '\0',  'T',  'Y',  'E',  'R', '\0', '\0', '\0', 0x01, '\0', '\0', '\0',  'T',  'A',  'L',
         'B', '\0', '\0', '\0', '1F', '\0', '\0', '\0',  'h',  't',  't',  'p',  ':',  '/',  '/',  'm',
         'p',  '3',  's',  'p',  'l',  't',  '.',  's',  'o',  'u',  'r',  'c',  'e',  'f',  'o',  'r',
         'g',  'e',  '.',  'n',  'e',  't',  'T',  'P',  'E',  '1', '\0', '\0', '\0', '1A', '\0', '\0',
        '\0',  'f',  'i',  'l',  'e',  ' ',  'w',  'r',  'a',  'p',  'p',  'e',  'd',  ' ',  'w',  'i',
         't',  'h',  ' ',  'M',  'p',  '3',  'W',  'r',  'a',  'p',  'T',  'I',  'T',  '2', '\0', '\0',
        '\0',  '&', '\0', '\0', '\0',  'U',  's',  'e',  ' ',  'M',  'p',  '3',  'S',  'p',  'l',  't',
         ' ',  't',  'o',  ' ',  'o',  'b',  't',  'a',  'i',  'n',  ' ',  'o',  'r',  'i',  'g',  'i',
         'n',  'a',  'l',  ' ',  't',  'r',  'a',  'c',  'k',  's', '\0', '\0', '\0', '\0', '\0', '\0',
...
int main (int argc, char *argv[])
{
    ...
    unsigned long splitpoints[MAXNUMFILE+1], 
                  begin=0, 
                  end, 
                  len=0, 
                  crc, 
    ...
    if (((!listoption) && (argc<4)) || ((listoption) && (argc < 3))) 
    {
        ...
        printf("\tTO SPLIT FILE USE 143Mp3Splt: http://mp3splt.sourceforge.net\n");  /* BUG */
        printf ("\nOPTIONS\n");
    ...
    if ((ptr=strstr(argv[0], "MP3WRAP.EXE"))!=NULL) 
        strncpy (filename, argv[0], (ptr-argv[0]));
        ...
        while ((fgets(filename, 511, file_input))!=NULL)
        {
            if ((ptr=strstr(filename, "EXT="))!=NULL)
            {
                if (strlen(filename)>1) 
                {
                    ...
                    {
                        if (verboption) 
                            printf ("Warning: your extension does not contain "WRAP" string!\n");
    ...
    if (addoption || listoption)
    {
        ...
        if (ismp3wrap)
        {
            ...
            for (i = 1; i<=oldfiles; i++)
            {
                ...
                {
                    if (verboption) 
                        printf ("%d) %lu\t", i, splitpoints[i]-splitpoints[i-1]);
                    printf ("%s\n", filename);
                }
            }
    ...
    if (files + oldfiles > 9)
        id3[21] = (((files + oldfiles) / 10) % 10) | 0x30;
    ...
    printf ("\n%s has been created successfully!\nUse mp3splt to dewrap file; download at http://544mp3splt.sourceforge.net!\n", filename);
    free(wrapindex);
